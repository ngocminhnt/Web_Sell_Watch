                ...
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children ">
                            <a href="getAll.htm"> <i class="ti-menu-alt"></i> Manage Categorys</a>
                        </li>
                        <li class="menu-item-has-children ">
            ...
            <div class="content">
                <div class="animated fadeIn">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <a class="btn btn-success"><h4>List Categorys</h4></a>
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="card-body" id="listProducers">
                                            ...
                                            <tbody>
                                                <c:forEach items="${ListCategories}" var="cat">
                                                    <tr>
                                                        ...
                                                        <td>${cat.catName}</td>
                                                        <td>
                                                            <c:if test = "${cat.catStatus == true}">
                                                                <c:out value = "Active"/>
                                                            </c:if>
                                                            <c:if test = "${cat.catStatus == false}">
                                                                <c:out value = "InActive"/>
                                                            </c:if></td>
                                                        <td>${cat.descriptons}</td>
                                                        <td>

                                                            <a href="initUpdate.htm?catId=${cat.catId}" class="btn btn-default">Update</a>
                                                            <a href="delete.htm?catId=${cat.catId}" class="btn btn-default">Delete</a>                           
                                                        </td>
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
                                        ...
                                        <div class="page-title">
                                            <a class="btn btn-outline-danger" href="initInsert.htm"><h3>Add Categorys</h3></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
