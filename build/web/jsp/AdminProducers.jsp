                ...
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children ">
                            <a href="getAll.htm"> <i class="ti-menu-alt"></i> Manage Producers</a>
                        </li>
                        <li class="menu-item-has-children ">
        ...
        <div id="right-panel" class="right-panel">
            ...
            <header id="header" class="header">
                ...
                <div class="header-menu">
                    ...
                    <div id="web" class="header-left">

                            <div><a href="${contextPath}/Web_Sell_Watch/WebProController/getAll.htm">Go to web</a></div>
                    ...
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            ...
                            <a class="nav-link" href="${pageContext.request.contextPath}/AdminController/logout.htm"><i class="fa fa-power -off"></i>Logout</a>
                        </div>
                    </div>
            ...
            <div class="content">
                <div class="animated fadeIn">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <a class="btn btn-success"><h4> List Producers</h4></a>
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="card-body" id="listProducers">
                                        <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                                    <th>ProducersId</th>
                                                    <th>ProducersName</th>
                                                    <th>ProducersStatus</th> 
                                                    <th>Action</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <c:forEach items="${ListProducers}" var="prodc">
                                                    <tr>
                                                        <td>${prodc.producersId}</td>
                                                        <td>${prodc.producersName}</td>
                                                        <td><c:if test = "${prodc.productStatus == true}">
                                                                <c:out value = "Active"/>
                                                            </c:if>
                                                            <c:if test = "${prodc.productStatus == false}">
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="initUpdate.htm?producersId=${prodc.producersId}" class="btn btn-default">Update</a> 
                                                            <a href="delete.htm?producersId=${prodc.producersId}" class="btn btn-default">Delete</a>
                                        ...
                                        <div class="page-title">
                                            <a class="btn btn-outline-danger"   href="initInsert.htm"><h3>Add Producers</h3></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
