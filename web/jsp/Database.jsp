...
<head>
    ...
    <title>Home</title>
    <meta name="description" content="YourFood - Trang ch?">
...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="getdata.html"><i class="fa fa-laptop"></i>Dashboard </a>
                    </li>
                    ...
                    <li class="menu-item-has-children ">
                        <a href="tableCart.html"><i class="fa fa-shopping-cart"></i> Manage Cart</a>
                    </li>
    ...
    <script src="../jsp/admin/Scripts/js/init/weather-init.js"></script>

    <script src="https://cdn.jsdelivr.net/npm/moment@2.22.2/moment.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/fullcalendar@3.9.0/dist/fullcalendar.min.js"></script>
    <script src="../jsp/admin/Scripts/js/init/fullcalendar-init.js"></script>
