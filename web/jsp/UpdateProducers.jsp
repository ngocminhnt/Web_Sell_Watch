...
<html>
    ...
    <body>
        ...
        <div id="right-panel" class="right-panel">
            <f:form action="update.htm" method="POST" commandName="prodcUpdate">
                <table id="table">
                    <tr>
                        <th colspan="2">Update Producers</th>
                    </tr>
                    <tr>
                        <td>Producers Id</td>
                        <td><f:input id="ip" path="producersId" readonly="true"/></td>
                    </tr>
                    <tr>
                        <td>Producers Name</td>
                        <td><f:input  id="ip" path="producersName" readonly="true"/></td>
                    </tr>

                    <tr>
                        <td>Producers Status</td>
                        <td>
                            <f:select id="ip" path="productStatus">
